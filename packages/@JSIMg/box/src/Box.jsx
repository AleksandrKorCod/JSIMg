import { UIPlugin } from '@JSIMg/core'
import { Provider } from '@JSIMg/companion-client'
import { ProviderViews } from '@JSIMg/provider-views'
...
export default class Box extends UIPlugin {
  ...
  constructor (JSIMg, opts) {
    super(JSIMg, opts)
    this.id = this.opts.id || 'Box'
    Provider.initPlugin(this, opts)
    this.title = this.opts.title || 'Box'
    this.icon = () => (
      <svg className="JSIMg-DashboardTab-iconBox" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
    ...
    this.provider = new Provider(JSIMg, {
